...
mod tests {
  ...
  "foo": {
    ...
    fn test_field_order_encoding_consistency() {
        // a_trigger has scope:treaty first, b_trigger has scope:treaty.amended_treaty first
    ...
    OR = {
        ...
        assert_eq!(
            a_json,
            "{\"a_trigger\":{\"OR\":{\"scope:treaty\":{\"is_renegotiation\":false},\"scope:treaty.amended_treaty\":{\"NOT_EQUAL\":\"this\"}}}}"
        );
        assert_eq!(
            b_json,
            "{\"b_trigger\":{\"OR\":{\"scope:treaty.amended_treaty\":{\"NOT_EQUAL\":\"this\"},\"scope:treaty\":{\"is_renegotiation\":false}}}}"
        );
    }
}
