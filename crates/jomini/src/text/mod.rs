...
//!    Deserialize streaming data with lower memory use for large models. See
//!    [TokenReader] for details about the streaming parser.
//!
...
//!  - [TokenReader]: An incremental text lexer designed for handling large
